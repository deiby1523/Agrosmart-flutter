...
class MilkingTableSkeleton extends StatelessWidget {
  final int rowCount;

  const MilkingTableSkeleton({
    super.key,
    this.rowCount = 10,
  });
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: DataTable(
          ...
          // Las columnas deben ser IDÉNTICAS a las de MilkingTable para evitar saltos visuales
          columns: [
            const DataColumn(label: _HeaderText('CANTIDAD (L)')),
            const DataColumn(label: _HeaderText('FECHA')),
