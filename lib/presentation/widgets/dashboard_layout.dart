...
class _DashboardLayoutState extends ConsumerState<DashboardLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        key: _scaffoldKey,
        // backgroundColor: theme.scaffoldBackgroundColor, // Asegúrate de que coincida
  ...
  Widget _buildUserInfoSection(User user, BuildContext context) {
    ...
    // Verificamos si estamos en móvil para ocultar el texto y evitar overflows
    final isMobile = MediaQuery.of(context).size.width < 600;

    return Padding(
      // SOLUCIÓN 1: Usar EdgeInsets en lugar de EdgeInsetsGeometry
      ...
      child: Row(
        ...
        children: [
          ...
          // SOLUCIÓN 2: Mostrar el texto del correo SOLO si NO es móvil
          if (!isMobile) ...[
            const SizedBox(width: _userInfoSpacing),
            Text(user.email.split('@')[0], style: theme.textTheme.bodyMedium),
          ],
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                // Logotipo
                Image.asset('assets/logos/logo.png', width: 30, height: 30),
