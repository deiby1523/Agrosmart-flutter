...
class PaddockReportPage extends ConsumerStatefulWidget {
  const PaddockReportPage({super.key});

  @override
  ConsumerState<PaddockReportPage> createState() => _PaddockReportPageState();
}

class _PaddockReportPageState extends ConsumerState<PaddockReportPage> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      await ref.read(reportsProvider.notifier).generatePaddockReport();
